...
window.startGame = function () {
  ...
  setTimeout(() => {
    spawnFallingEvent(
      400,
      "อะแฮ่มๆๆๆ สวัสดีครับ เขินนะเนี่ยทำอะไรแบบนี้โอเคๆ อันนี้คือความทรงจำชิ้นแรกนะเจ้าวาฬข้าวปั้น เห็น logo นั่นมั้ยยย ใช่แล้ว roblox ไงละ คุณก็คงจำได้แหละเนาะการเจอกันครั้งแรกที่แบบงงๆ5555 จากคนที่ทักทาย จนอยู่กันถึงตี 4 จนผมเริ่มทักแชทไปบ่นกับคุณ แต่รู้มั้ยว่าอะไรในตัวจงที่ตกผม ตอนนั้นหนะมันจะมีตัวละครที่แต่งเป็นเอเลี่ยนแล้วเขาพูดภาษาอังกฤษ ตอนแรกเราก็คุยเล่นสนุกๆจนเขาเริ่มขอๆอจีเราละเราไม่ชอบ เราพยายามไม่ให้ละคุณก็เดินมาคุยแนให้ว่า no no ไม่ๆ อะไรนี่แหละ อะแฮะ จังหวะตกหลุมรักเลยป้ะ ><",
